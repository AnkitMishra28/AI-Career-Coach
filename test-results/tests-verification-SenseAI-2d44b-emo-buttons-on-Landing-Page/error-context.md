...
- Name: tests\verification.spec.js >> SenseAI System & UI Verification >> 2. "Launch Career OS" and "Explore Live Demo" buttons on Landing Page
- Location: tests\verification.spec.js:28:7
...
=========================== logs ===========================
waiting for navigation to "**/demo" until "load"
============================================================
```
        ...
        - generic [ref=e35]:
          - generic [ref=e36]:
            ...
            - link [ref=e39] [cursor=pointer]:
              - /url: /demo
              - button "Explore Live Demo" [active] [ref=e40]
          - generic [ref=e41]:
